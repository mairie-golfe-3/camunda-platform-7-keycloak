...
public class KeycloakIdentityProviderFactory implements SessionFactory {
	...
	/**
	 * @param tenantQueryCache set the queryCache for tenant queries
	 */
	...
	public Session openSession() {
		return new KeycloakIdentityProviderSession(
						keycloakConfiguration, restTemplate, keycloakContextProvider, userQueryCache, groupQueryCache, tenantQueryCache, checkPasswordCache);
	}
